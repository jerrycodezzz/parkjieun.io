  ...
  const archiveItems = [
    {
      ...
      icon: (
        <svg className="w-7 h-7 mx-3" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5 mx-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <section id="archiving" className="w-full ">
      <div className="w-full max-w-none mx-auto from-primary-30 to-primary-40 bg-gradient-to-b min-h-screen py-32">
        ...
        <div className="grid md:grid-rows-3 gap-8 max-w-6xl mx-auto ">
          {archiveItems.map((item, index) => (
            <motion.div
              ...
              <Button
                ...
                className="px-8 py-2 text-primary-60 border border-primary-40 hover:bg-primary-10 transition-all duration-300">
                {item.icon}
                {item.title}
                {item.description}
                {item.icon}
